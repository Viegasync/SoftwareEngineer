...
internal static class StudentFactory
{
    ...
    /// </summary>
    private static StudentRequest AverageStudent() => new()
    {
    ...
    /// </summary>
    private static StudentRequest GoodStudent() => new()
    {
    ...
    /// </summary>
    private static StudentRequest BadStudent() => new()
    {
    ...
    /// </summary>
    private static StudentRequest MixedStudent() => new()
    {
    ...
    /// </summary>
    private static StudentRequest VariedStudent() => new()
    {
